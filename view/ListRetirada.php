        ...
        <div class="navbar">
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
                    <a class="navbar-brand" onclick="location.href='index.html'">WRK</a>
...
<?php
    ...
    <div class="footer">
            <footer class="bg-terciary text-blue text-center text-lg-start">
                <!-- Grid container -->
                <div class="container p-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                      <h5 class="text-uppercase">WRK</h5>
              
                      <p>
                        Explore o mundo do conhecimento com facilidade usando nosso sistema de biblioteca inteligente.
                      </p>
                    </div>
                    <!--Grid column-->
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                      ...
                      <ul class="list-unstyled mb-0">
                        ...
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-reddit" viewBox="0 0 16 16">
